import { FaXTwitter, FaYoutube, FaLinkedin, FaInstagram, FaTelegram, FaFacebook } from "react-icons/fa6";
const Footer = () => {
    return (
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="text-sm mt-2 space-y-2">
              ...
              <li>Careers <span className="bg-blue-500 text-white px-2 py-1 rounded text-xs">We're hiring</span></li>
              <li>Security</li>
              <li>Refund Policy</li>
              <li>Brand Assets</li>
              <li>Terms of Use</li>

                ...
                <div className='datatax flex flex-col gap-7'>
                    <div className='flex flex-col md:flex-row justify-between gap-4'>
                        <div className='flex flex-col md:flex-row items-center gap-4'>
                            ...
                            <select className='bg-page rounded-lg px-4 py-2 font-bold'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                        <div className='flex flex-col w-full'>
                            ...
                            <div className='flex'>
                                <span className='w-1/5 bg-page rounded-l-lg flex items-center justify-center'>$</span>
                                <input type="number" className='w-4/5 bg-page rounded-r-lg p-2' value={purchase} onChange={(e) => setPurchase(e.target.value)} />
                            </div>
                        </div>
                        <div className='flex flex-col w-full'>
                            ...
                            <div className='flex'>
                                <span className='w-1/5 bg-page rounded-l-lg flex items-center justify-center'>$</span>
                                <input type="number" className='w-4/5 bg-page rounded-r-lg p-2' value={sale} onChange={(e) => setSale(e.target.value)} />
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col md:flex-row gap-4'>
                        <div className='flex flex-col w-full'>
                            ...
                            <div className='flex'>
                                <span className='w-1/5 bg-page rounded-l-lg flex items-center justify-center'>$</span>
                                <input type="number" className='w-4/5 bg-page rounded-r-lg p-2' value={exp} onChange={(e) => setExp(e.target.value)} />
                            </div>
                        </div>
                        <div className='flex flex-col w-full'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                        <div className='flex flex-col w-full'>
                            ...
                            <select className='p-2 bg-page rounded-lg' onChange={(e) => incomechanges(e.target.value)}>
                        ...
                        <div className='flex flex-col w-full'>
                            <span>Tax rate</span>
                            <div className='p-2 bg-page rounded-lg'>{tax}</div>
                        </div>
                    </div>
                    <div className={`flex flex-col md:flex-row gap-4 ${tick ? 'invisible' : 'visible'}`}>
                        <div className='flex flex-col w-full'>
                            <span>Capital gains amount</span>
                            <input type="text" className='p-2 bg-page rounded-lg' value={capitalGain} readOnly />
                        </div>
                        <div className='flex flex-col w-full'>
                            <span>Discount for long term gains</span>
                            <input type="text" className='p-2 bg-page rounded-lg' value={capitalGain >= 0 ? longterm : 0} readOnly />
                        </div>
                    </div>
                    <div className='flex flex-col md:flex-row gap-4'>
